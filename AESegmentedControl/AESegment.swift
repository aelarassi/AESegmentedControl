...
/// A segment button embed in AESegmentedControl
@objcMembers
public class AESegment: UIButton {
    ...
    @discardableResult public func set(width: CGFloat) -> AESegment {
        self.width = width
        return self
    }
    
    @discardableResult public func set(image position: ImagePosition) -> AESegment {
        self.imagePosition = position
        return self
    }
    
    @discardableResult public func set(padding: CGFloat) -> AESegment {
        self.padding = padding
        return self
    }
    
    @discardableResult public func set(title: String?, for state: UIControl.State = .normal) -> AESegment {
        super.setTitle(title, for: state)
        return self
    }
    
    @discardableResult public func set(titleColor: UIColor?, for state: UIControl.State = .normal) -> AESegment {
        super.setTitleColor(titleColor, for: state)
        return self
    }
    
    @discardableResult public func set(image: UIImage?, for state: UIControl.State = .normal) -> AESegment {
        super.setImage(image, for: state)
        return self
    }
    
    @discardableResult public func set(background image: UIImage?, for state: UIControl.State = .normal) -> AESegment {
        super.setBackgroundImage(image, for: state)
        return self
    }
    
    @discardableResult public func set(attributedTitle: NSAttributedString?, for state: UIControl.State = .normal) -> AESegment {
