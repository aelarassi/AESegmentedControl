...
/// A AESegmentedControl object is a horizontal control made of multiple segments, each segment functioning as a button. An indicator shows the current position of the selected segment.
...
/// The AESegmentedControl object automatically resizes segments to fit proportionally within their superview unless they have a specific width set.
///
...
@IBDesignable
@objcMembers
open class AESegmentedControl: UIControl {
    ...
    public let indicator = AEIndicator()
...
extension AESegmentedControl {
    ...
    public func segment(at index: Int) -> AESegment? {
    ...
    public func newSegment() -> AESegment {
        
        let segment = AESegment()
        ...
        segment.addTarget(self, action: #selector(AESegmentedControl.select(segment:)), for: .touchUpInside)
        
        contentView.append(segment)
        return segment
    }
    
    @objc private func select(segment: AESegment) {
    ...
    @discardableResult public func append(title: String) -> AESegment {
    ...
    ///
    /// - Parameter title: The new segment title.
    @discardableResult public func append(attributedTitle: NSAttributedString) -> AESegment {
        let segment = newSegment()
    ...
    @discardableResult public func append(image: UIImage?) -> AESegment {
        let segment = newSegment()
...
extension AESegmentedControl {
    ...
    class ContentView: UIView {
        ...
        var segments = [AESegment]()
        
        var separators = Separators()
        
        func append(_ segment: AESegment) {
        ...
        func remove(_ segment: AESegment) {
